...
- Gamma Distribution : $X->Gamma ( \alpha , \beta )$
- pdf of Gamma Distribution : $f _{X} (x)= \frac{1}  {\gamma ( \alpha ) \beta  ^{\alpha }} x ^{\alpha -1} e ^{-\frac {1}  {\beta }} , x>0$
- Gamma function : $\gamma ( \alpha )= \int _{0} ^{INF } {x ^{\alpha -1} e ^{-x} dx,x>0}$
- Binomial Distribution : $X -> Binomial(p)$
