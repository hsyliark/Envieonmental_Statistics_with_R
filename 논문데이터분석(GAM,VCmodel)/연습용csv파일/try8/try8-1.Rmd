...
#### 최종선택된 모형의 설명력(Deviance explained) : 0.6432(다중선형회귀모형), 0.6895(일반화선형모형(Gamma)), 0.7580(일반화가법모형(Gamma)), 0.8610(일반화가법모형(quasi)), 0.7650(시간에 따른 계수변화모형(Gamma)), (시간에 따른 계수변화모형(quasi)) 

#### train data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : 25.22254(다중선형회귀모형), 27.61937(일반화선형모형(Gamma)), 22.02983(일반화가법모형(Gamma)), 15.75888(일반화가법모형(quasi)), 20.53300(시간에 따른 계수변화모형(Gamma)), (시간에 따른 계수변화모형(quasi))

#### test data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : 44.64382(다중선형회귀모형), 54.40775(일반화선형모형(Gamma)), 48.02430(일반화가법모형(Gamma)), 47.07609(일반화가법모형(quasi)), 163.50830(시간에 따른 계수변화모형(Gamma)), (시간에 따른 계수변화모형(quasi))
