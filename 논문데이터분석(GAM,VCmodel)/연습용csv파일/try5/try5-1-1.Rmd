...
#### train data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : 28850.56(다중선형회귀모형), 21249.70(일반화선형모형), 13705.35(일반화가법모형), (시간에 따른 계수변화모형)
...
#### 여러가지 사항을 고려했을 때 광산 TC 예측에 대한 최적의 모형은 GAM이라고 판단됨.
...
ggplot(data.mlr, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.mlr$time,data.mlr$response,type='o',col='blue',xlab="time",ylab="FC",main="[Gwangsan FC train data] response vs fitted_values (Multiple Linear Regression)",ylim=c(-100000,500000))
lines(data.mlr$time,data.mlr$fitted_values,type='o',col='red')
legend(0,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.mlr1, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.mlr1$time,data.mlr1$response,type='o',col='blue',xlab="time",ylab="FC",main="[Gwangsan FC test data] response vs fitted_values (Multiple Linear Regression)",ylim=c(-100000,500000))
lines(data.mlr1$time,data.mlr1$fitted_values,type='o',col='red')
legend(3650,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.glm, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.glm$time,data.glm$response,type='o',col='blue',xlab="time",ylab="FC",main="[Gwangsan FC train data] response vs fitted_values (Generalized Linear Model)",ylim=c(-100000,500000))
lines(data.glm$time,data.glm$fitted_values,type='o',col='red')
legend(0,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.glm1, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.glm1$time,data.glm1$fitted_values,type='o',col='red',xlab="time",ylab="FC",main="[Gwangsan FC test data] response vs fitted_values (Generalized Linear Model)",ylim=c(-100000,500000))
lines(data.glm1$time,data.glm1$response,type='o',col='blue')
legend(3650,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.gam, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.gam$time,data.gam$response,type='o',col='blue',xlab="time",ylab="FC",main="[Gwangsan FC train data] response vs fitted_values (Generalized Additive Model)",ylim=c(-100000,500000))
lines(data.gam$time,data.gam$fitted_values,type='o',col='red')
legend(0,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.gam1, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.gam1$time,data.gam1$fitted_values,type='o',col='red',xlab="time",ylab="FC",main="[Gwangsan FC test data] response vs fitted_values (Generalized Additive Model)",ylim=c(-100000,500000))
lines(data.gam1$time,data.gam1$response,type='o',col='blue')
legend(3650,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.tvcm, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.tvcm$time,data.tvcm$response,type='o',col='blue',xlab="time",ylab="FC",main="[Gwangsan FC train data] response vs fitted_values (Time Varying Coefficient Model)",ylim=c(-100000,500000))
lines(data.tvcm$time,data.tvcm$fitted_values,type='o',col='red')
legend(0,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
...
ggplot(data.tvcm1, aes(x=response, y=fitted_values)) +
  ...
  geom_abline(intercept=0,slope=1,color='blue',size=1.5)
par(mfrow=c(1,1))
plot(data.tvcm1$time,data.tvcm1$fitted_values,type='o',col='red',xlab="time",ylab="FC",main="[Gwangsan FC test data] response vs fitted_values (Time Varying Coefficient Model)",ylim=c(-100000,500000))
lines(data.tvcm1$time,data.tvcm1$response,type='o',col='blue')
legend(3650,500000,c("fitted_values","response"),lwd=c(1,1),col=c("red","blue"))
```
