...
data.mlr <- data.frame(response=ex1_1$TC,fitted_values=pred.mlr)
...
data.glm <- data.frame(response=ex1_1$TC,fitted_values=pred.glm)
...
data.gam <- data.frame(response=ex1_1$TC,fitted_values=pred.gam)
...
data.tvcm <- data.frame(response=ex1_1$TC,fitted_values=pred.tvcm)
