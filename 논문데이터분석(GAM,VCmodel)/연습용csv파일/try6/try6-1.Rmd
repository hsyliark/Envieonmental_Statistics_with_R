...
#### 최종선택된 모형의 설명력(Deviance explained) : %(다중선형회귀모형), %(일반화선형모형(Gamma)), %(일반화가법모형(Gamma)), %(일반화가법모형(quasi)), %(시간에 따른 계수변화모형(Gamma)), %(시간에 따른 계수변화모형(quasi))

#### train data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : (다중선형회귀모형), (일반화선형모형(Gamma)), (일반화가법모형(Gamma)), (일반화가법모형(quasi)), (시간에 따른 계수변화모형(Gamma)), (시간에 따른 계수변화모형(quasi))

#### test data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : (다중선형회귀모형), (일반화선형모형(Gamma)), (일반화가법모형(Gamma)), (일반화가법모형(quasi)), (시간에 따른 계수변화모형(Gamma)), (시간에 따른 계수변화모형(quasi))
