...
- $r _{s} = \frac {{\sum _{j=1} ^{n} (r _{xj} - {\bar{r _{x}}} )(r _{yj} - {\bar{r _{y}}} )}}  {\sqrt {\sum _{j=1} ^{n} (r _{xj} - {\bar{r _{x}}} ) ^{2} \sum _{j=1} ^{n} (r _{yj} - {\bar{r _{y}}} ) ^{2}}} =1- \frac {{6} \sum _{j=1} ^{n} (r _{xj} -r _{yj} ) ^{2}}  {n(n ^{2} -1)} $
- $Z= \frac {r _{s}} {\sqrt {\frac {1}  {n-1}}} -> N(0,1)$ if  $n>=10$
- $T= \frac {r _{s} \sqrt {n-2}} {\sqrt {1-r _{s}^{2}}} -> t _{n-2}$ if $n >= 20$
...
- $y _{i} = \beta  _{0} + \beta  _{1} x _{1i} + \beta  _{2} x _{2i} +...+ \beta  _{k} x _{ki} + \epsilon  _{i} ,$
$\epsilon  _{i} ->i.i.d  N(0, \sigma  ^{2} ) , i=1,2,...,n$
- Normal Distribution
- $X -> N( \mu , \sigma  ^{2} ) --> f _{X} (x)= \frac{1} {\sqrt {2 \pi } \sigma } exp (  - \frac{1}  {2 \sigma  ^{2}} (x- \mu ) ^{2}) , x \in R $
...
- $g[E(y )]= \beta  _{0} + \beta  _{1} x _{1} + \beta  _{2} x _{2} +...+ \beta  _{k} x _{k}$
- Poisson Distribution
- $X -> Poisson( \lambda )-->P _{X} (X=x)=\frac {e ^{- \lambda } \lambda  ^{x}}  {x!} , x=0,1,2,3,...$
- Gamma Distribution
- $X->Gamma ( \alpha , \beta )-->f _{X} (x)= \frac{1}  {\gamma ( \alpha ) \beta  ^{\alpha }} x ^{\alpha -1} e ^{-\frac {1}  {\beta }} , x>0$
- $\gamma ( \alpha )= \int _{0} ^{INF } {x ^{\alpha -1} e ^{-x} dx,x>0}$
- Binomial Distribution
- $X -> B(p) --> P _{X} (X=x)= _{n} C _{x} p ^{x} (1-p) ^{n-x} , x=0,1,2,...,n$
- Log Poisson Model(포아송분포 가정) : $log(y)= \beta  _{0} + \beta  _{1} x _{1} + \beta  _{2} x _{2} +...+ \beta  _{k} x _{k}$
- Log Gamma Model(감마분포 가정) : $log(y)= \beta  _{0} + \beta  _{1} x _{1} + \beta  _{2} x _{2} +...+ \beta  _{k} x _{k}$
- Logistic Model(2개의 집단일 경우 이항분포 가정) : $log(\frac {p }  {1-p} )= \beta  _{0} + \beta  _{1} x _{1} + \beta  _{2} x _{2} +...+ \beta  _{k} x _{k}$
- 이외에도 다양한 모형이 존재함.
...
- $g[E(y)]= \beta  _{0} +f _{1} (x _{1} )+f _{2} (x _{2} )+...+f _{k} (x _{k} )$
- Log Poisson Model(포아송분포 가정) : $log(y)= \beta  _{0} +f _{1} (x _{1} )+f _{2} (x _{2} )+...+f _{k} (x _{k} )$ 
- Log Gamma Model(감마분포 가정) : $log(y)= \beta  _{0} +f _{1} (x _{1} )+f _{2} (x _{2} )+...+f _{k} (x _{k} )$
- Logistic Model(2개의 집단일 경우 이항분포 가정) : $log(\frac {p }  {1-p} )= \beta  _{0} +f _{1} (x _{1} )+f _{2} (x _{2} )+...+f _{k} (x _{k} )$
- Log Quasi Model : $log(y)= \beta  _{0} +f _{1} (x _{1} )+f _{2} (x _{2} )+...+f _{k} (x _{k} )$  
- 이외에도 다양한 모형이 존재함.
- 시간에 따른 계수변화모형 : 역시 일반화선형모형의 확장으로 시간에 의존하는 변수의 특성을 감안하여 계수가 시간에 따라 변화한다고 가정한 모형.
- $g[E(y)]= \beta  _{0} (t)+ \beta  _{1} (t)x _{1} + \beta  _{2} (t)x _{2} +...+ \beta  _{k} (t)x _{k}$
- Log Poisson Model(포아송분포 가정) : $log(y)= \beta  _{0} (t)+ \beta  _{1} (t)x _{1} + \beta  _{2} (t)x _{2} +...+ \beta  _{k} (t)x _{k}$
- Log Gamma Model(감마분포 가정) : $log(y)= \beta  _{0} (t)+ \beta  _{1} (t)x _{1} + \beta  _{2} (t)x _{2} +...+ \beta  _{k} (t)x _{k}$
- Logistic Model(2개의 집단일 경우 이항분포 가정) : $log(\frac {p }  {1-p} )= \beta  _{0} (t)+ \beta  _{1} (t)x _{1} + \beta  _{2} (t)x _{2} +...+ \beta  _{k} (t)x _{k}$
- Log Quasi Model : $log(y)= \beta  _{0} (t)+ \beta  _{1} (t)x _{1} + \beta  _{2} (t)x _{2} +...+ \beta  _{k} (t)x _{k}$ 
...
- $C _{p} = \frac {SSE _{p}} {\sigma  ^{2}} +2k-n$
...
plot(mm,residuals=TRUE,pch=1,shade=TRUE,seWithMean=TRUE,shift=coef(mm)[1])
ggGam(mm)
summary(mm) # Deviance explained = 84%  
concurvity(mm,full=TRUE) # 공선성 존재
par(mfrow=c(2,2))
gam.check(mm) # 적합결여 존재 (기저함수 부족)
par(mfrow=c(1,1))
...
plot(mm.shrink,residuals=TRUE,pch=1,shade=TRUE,seWithMean=TRUE,shift=coef(mm.shrink)[1])
ggGam(mm.shrink) # 선택변수 : pH, DO, BOD, COD, SS, TN, TP, WT, log(TC), NH3N, PO4P, log(Chla), Flow, Rain 
summary(mm.shrink) # Deviance explained = 83%  
concurvity(mm.shrink,full=TRUE) # 공선성 존재
par(mfrow=c(2,2))
gam.check(mm.shrink) # 적합결여 존재 (기저함수 부족)
par(mfrow=c(1,1))
...
data.gam <- data.frame(response=ex2$FC,fitted_values=pred.gam,
                       time=ex2$time)
sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
       length(data.gam$response)) # RMSE = 846.8591     
ggplot(data.gam, aes(x=response, y=fitted_values)) +
  geom_point() + geom_rug() +
  ggtitle("[Uchi FC train data] response vs fitted_values 
          (Generalized Additive Model)") +
...
data.gam1 <- data.frame(response=ex2_1$FC,fitted_values=pred.gam1,
                        time=ex2_1$time)
sqrt(sum((data.gam1$response-data.gam1$fitted_values)^2)/
       length(data.gam1$response)) # RMSE = 1037.272   
ggplot(data.gam1, aes(x=response, y=fitted_values)) +
  geom_point() + geom_rug() +
  ggtitle("[Uchi FC test data] response vs fitted_values 
          (Generalized Additive Model)") +
...
plot(vc.shrink,residuals=TRUE,pch=1,shade=TRUE,seWithMean=TRUE,shift=coef(vc.shrink)[1],ylim=c(-40,40))
ggGam(vc.shrink) # 선택변수 : pH, BOD, COD, SS, TN, TP, TOC, WT, EC, log(TC), PO4P, log(Chla), Flow, Rain 
summary(vc.shrink) # Deviance explained = 92.3%  
par(mfrow=c(2,2))
gam.check(vc.shrink) 
par(mfrow=c(1,1))
```
...
data.tvcm <- data.frame(response=ex2$FC,fitted_values=pred.tvcm,
                        time=ex2$time)
sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
       length(data.tvcm$response)) # RMSE = 425.9714     
ggplot(data.tvcm, aes(x=response, y=fitted_values)) +
  geom_point() + geom_rug() +
  ggtitle("[Uchi FC train data] response vs fitted_values 
          (Time Varying Coefficient Model)") +
...
data.tvcm1 <- data.frame(response=ex2_1$FC,fitted_values=pred.tvcm1,
                         time=ex2_1$time)
sqrt(sum((data.tvcm1$response-data.tvcm1$fitted_values)^2)/
       length(data.tvcm1$response)) # RMSE = 240383.3   
ggplot(data.tvcm1, aes(x=response, y=fitted_values)) +
  geom_point() + geom_rug() +
  ggtitle("[Uchi FC test data] response vs fitted_values 
          (Time Varying Coefficient Model)") +
...
#### 최종선택된 모형의 설명력(Deviance explained) : 19.7%(다중선형회귀모형), 68.1%(일반화선형모형), 83.0%(일반화가법모형), 92.3%(시간에 따른 계수변화모형)

#### train data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : 2336.716(다중선형회귀모형), 1778.897(일반화선형모형), 846.8591(일반화가법모형), 425.9714(시간에 따른 계수변화모형)

#### test data 관련 최종선택된 모형의 예측력(Root Mean Squared Error) : 1208.648(다중선형회귀모형), 1243.96(일반화선형모형), 1037.272(일반화가법모형), 240383.3(시간에 따른 계수변화모형)
...
#### 여러가지 사항을 고려했을 때 우치 FC 예측에 대한 최적의 모형은 GAM이라고 판단됨.
