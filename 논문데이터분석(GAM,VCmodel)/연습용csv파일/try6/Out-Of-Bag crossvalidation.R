...
for (i in 1:50) {
  ...
  print(c('TC1.MLR',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                             length(data.mlr$response))))
  ...
  print(c('TC1.GLM',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                             length(data.glm$response))))
  ...
  print(c('TC1.GAM',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                             length(data.gam$response))))
  ...
  print(c('TC1.TVCM',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                              length(data.tvcm$response))))
}
...
for (i in 1:50) {
  ...
  FC1.RMSE.mlr <- c(FC1.RMSE.mlr,
                sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                       length(data.mlr$response)))
  print(c('FC1.MLR',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                             length(data.mlr$response))))
  # Generalized Linear Model
  ...
  FC1.RMSE.glm <- c(FC1.RMSE.glm,
                sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                       length(data.glm$response)))
  print(c('FC1.GLM',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                             length(data.glm$response))))
  # Generalized Additive Model
  ...
  FC1.RMSE.gam <- c(FC1.RMSE.gam,
                sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                       length(data.gam$response)))
  print(c('FC1.GAM',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                             length(data.gam$response))))
  # Time Varying Coefficient Model
  ...
  FC1.RMSE.tvcm <- c(FC1.RMSE.tvcm,
                 sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                        length(data.tvcm$response)))
  print(c('FC1.TVCM',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                              length(data.tvcm$response))))
}
...
for (i in 1:50) {
  ...
  Chla1.RMSE.glm <- c(Chla1.RMSE.glm,
                    sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                           length(data.glm$response)))
  print(c('Chla1.GLM',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response))))
  # Generalized Additive Model
  ...
  Chla1.RMSE.gam <- c(Chla1.RMSE.gam,
                    sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                           length(data.gam$response)))
  print(c('Chla1.GAM',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response))))
  # Time Varying Coefficient Model
  ...
  Chla1.RMSE.tvcm <- c(Chla1.RMSE.tvcm,
                     sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                            length(data.tvcm$response)))
  print(c('Chla1.TVCM',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                length(data.tvcm$response))))
}
...
for (i in 1:50) {
  ...
  TC2.RMSE.mlr <- c(TC2.RMSE.mlr,
                    sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                           length(data.mlr$response)))
  print(c('TC2.MLR',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                             length(data.mlr$response))))
  # Generalized Linear Model
  m <- glm(TC~pH+DO+BOD+COD+SS+TN+TP+TOC+WT+EC+log(Chla)+
             NH3N+PO4P+log(FC)+Flow+Rain,data=train,
  ...
  TC2.RMSE.glm <- c(TC2.RMSE.glm,
                    sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                           length(data.glm$response)))
  print(c('TC2.GLM',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                             length(data.glm$response))))
  # Generalized Additive Model
  mm.shrink <- gam(TC~s(pH)+s(DO)+s(BOD)+s(COD)+s(SS)+s(TN)+s(TP)
                   +s(TOC)+s(WT)+s(EC)+s(log(Chla))+s(NH3N)+s(PO4P)
  ...
  TC2.RMSE.gam <- c(TC2.RMSE.gam,
                    sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                           length(data.gam$response)))
  print(c('TC2.GAM',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                             length(data.gam$response))))
  # Time Varying Coefficient Model
  vc.shrink <- gam(TC~s(time)+s(time,by=pH)+s(time,by=DO)+
                     s(time,by=BOD)+s(time,by=COD)+s(time,by=SS)+
  ...
  TC2.RMSE.tvcm <- c(TC2.RMSE.tvcm,
                     sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                            length(data.tvcm$response)))
  print(c('TC2.TVCM',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                              length(data.tvcm$response))))
}
...
for (i in 1:50) {
  ...
  FC2.RMSE.mlr <- c(FC2.RMSE.mlr,
                    sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                           length(data.mlr$response)))
  print(c('FC2.MLR',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                             length(data.mlr$response))))
  # Generalized Linear Model
  m <- glm(FC~pH+DO+BOD+COD+SS+TN+TP+TOC+WT+EC+log(Chla)+
             NH3N+PO4P+log(TC)+Flow+Rain,data=train,
  ...
  FC2.RMSE.glm <- c(FC2.RMSE.glm,
                    sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                           length(data.glm$response)))
  print(c('FC2.GLM',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                             length(data.glm$response))))
  # Generalized Additive Model
  mm.shrink <- gam(FC~s(pH)+s(DO)+s(BOD)+s(COD)+s(SS)+s(TN)+s(TP)
                   +s(TOC)+s(WT)+s(EC)+s(log(Chla))+s(NH3N)+s(PO4P)
  ...
  FC2.RMSE.gam <- c(FC2.RMSE.gam,
                    sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                           length(data.gam$response)))
  print(c('FC2.GAM',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                             length(data.gam$response))))
  # Time Varying Coefficient Model
  vc.shrink <- gam(FC~s(time)+s(time,by=pH)+s(time,by=DO)+
                     s(time,by=BOD)+s(time,by=COD)+s(time,by=SS)+
  ...
  FC2.RMSE.tvcm <- c(FC2.RMSE.tvcm,
                     sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                            length(data.tvcm$response)))
  print(c('FC2.TVCM',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                              length(data.tvcm$response))))
}
...
for (i in 1:50) {
  ...
  Chla2.RMSE.glm <- c(Chla2.RMSE.glm,
                      sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                             length(data.glm$response)))
  print(c('Chla2.GLM',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response))))
  # Generalized Additive Model
  mm.shrink <- gam(Chla~s(pH)+s(DO)+s(BOD)+s(COD)+s(SS)+s(TN)+s(TP)
                   +s(TOC)+s(WT)+s(EC)+s(log(FC))+s(NH3N)+s(PO4P)
  ...
  Chla2.RMSE.gam <- c(Chla2.RMSE.gam,
                      sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                             length(data.gam$response)))
  print(c('Chla2.GAM',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response))))
  # Time Varying Coefficient Model
  vc.shrink <- gam(Chla~s(time)+s(time,by=pH)+s(time,by=DO)+
                     s(time,by=BOD)+s(time,by=COD)+s(time,by=SS)+
  ...
  Chla2.RMSE.tvcm <- c(Chla2.RMSE.tvcm,
                       sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                              length(data.tvcm$response)))
  print(c('Chla2.TVCM',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                length(data.tvcm$response))))
}
...
for (i in 1:50) {
  ...
  TC1.Bag.RMSE.mlr <- c(TC1.Bag.RMSE.mlr,
                    sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                           length(data.mlr$response)))
  print(c('TC1.Bag.mlr',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                                 length(data.mlr$response))))
  ...
  TC1.Bag.RMSE.glm <- c(TC1.Bag.RMSE.glm,
                        sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response)))
  print(c('TC1.Bag.glm',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                 length(data.glm$response))))
  ...
  TC1.Bag.RMSE.gam <- c(TC1.Bag.RMSE.gam,
                        sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response)))
  print(c('TC1.Bag.gam',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                 length(data.gam$response))))
  ...
  TC1.Bag.RMSE.tvcm <- c(TC1.Bag.RMSE.tvcm,
                        sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                               length(data.tvcm$response)))
  print(c('TC1.Bag.tvcm',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                 length(data.tvcm$response))))
  print('TC1.bag',i)
}
...
for (i in 1:50) {
  ...
  FC1.Bag.RMSE.mlr <- c(FC1.Bag.RMSE.mlr,
                        sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                               length(data.mlr$response)))
  print(c('FC1.Bag.mlr',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                                 length(data.mlr$response))))
  pred.bag.glm.final <- rowMeans(pred.bag.glm)
  ...
  FC1.Bag.RMSE.glm <- c(FC1.Bag.RMSE.glm,
                        sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response)))
  print(c('FC1.Bag.glm',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                 length(data.glm$response))))
  pred.bag.gam.final <- rowMeans(pred.bag.gam)
  ...
  FC1.Bag.RMSE.gam <- c(FC1.Bag.RMSE.gam,
                        sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response)))
  print(c('FC1.Bag.gam',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                 length(data.gam$response))))
  pred.bag.tvcm.final <- rowMeans(pred.bag.tvcm)
  ...
  FC1.Bag.RMSE.tvcm <- c(FC1.Bag.RMSE.tvcm,
                         sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                length(data.tvcm$response)))
  print(c('FC1.Bag.tvcm',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                 length(data.tvcm$response))))
  print('FC1.bag',i)
}
...
for (i in 1:50) {
  ...
  Chla1.Bag.RMSE.glm <- c(Chla1.Bag.RMSE.glm,
                        sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response)))
  print(c('Chla1.Bag.glm',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                   length(data.glm$response))))
  pred.bag.gam.final <- rowMeans(pred.bag.gam)
  ...
  Chla1.Bag.RMSE.gam <- c(Chla1.Bag.RMSE.gam,
                        sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response)))
  print(c('Chla1.Bag.gam',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                   length(data.gam$response))))
  pred.bag.tvcm.final <- rowMeans(pred.bag.tvcm)
  ...
  Chla1.Bag.RMSE.tvcm <- c(Chla1.Bag.RMSE.tvcm,
                         sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                length(data.tvcm$response)))
  print(c('Chla1.Bag.tvcm',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                   length(data.tvcm$response))))
  print('Chla1.bag',i)
}
...
for (i in 1:50) {
  ...
  TC2.Bag.RMSE.mlr <- c(TC2.Bag.RMSE.mlr,
                        sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                               length(data.mlr$response)))
  print(c('TC2.Bag.mlr',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                                   length(data.mlr$response))))
  pred.bag.glm.final <- rowMeans(pred.bag.glm)
  data.glm <- data.frame(response=test$TC,fitted_values=pred.bag.glm.final,
                         time=test$time)
  TC2.Bag.RMSE.glm <- c(TC2.Bag.RMSE.glm,
                        sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response)))
  print(c('TC2.Bag.glm',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                 length(data.glm$response))))
  pred.bag.gam.final <- rowMeans(pred.bag.gam)
  data.gam <- data.frame(response=test$TC,fitted_values=pred.bag.gam.final,
                         time=test$time)
  TC2.Bag.RMSE.gam <- c(TC2.Bag.RMSE.gam,
                        sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response)))
  print(c('TC2.Bag.gam',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                 length(data.gam$response))))
  pred.bag.tvcm.final <- rowMeans(pred.bag.tvcm)
  data.tvcm <- data.frame(response=test$TC,fitted_values=pred.bag.tvcm.final,
                          time=test$time)
  TC2.Bag.RMSE.tvcm <- c(TC2.Bag.RMSE.tvcm,
                         sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                length(data.tvcm$response)))
  print(c('TC2.Bag.tvcm',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                 length(data.tvcm$response))))
  print('TC2.bag',i)
}
...
for (i in 1:50) {
  ...
  FC2.Bag.RMSE.mlr <- c(FC2.Bag.RMSE.mlr,
                        sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                               length(data.mlr$response)))
  print(c('FC2.Bag.mlr',i,sqrt(sum((data.mlr$response-data.mlr$fitted_values)^2)/
                                 length(data.mlr$response))))
  pred.bag.glm.final <- rowMeans(pred.bag.glm)
  data.glm <- data.frame(response=test$FC,fitted_values=pred.bag.glm.final,
                         time=test$time)
  FC2.Bag.RMSE.glm <- c(FC2.Bag.RMSE.glm,
                        sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                               length(data.glm$response)))
  print(c('FC2.Bag.glm',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                 length(data.glm$response))))
  pred.bag.gam.final <- rowMeans(pred.bag.gam)
  data.gam <- data.frame(response=test$FC,fitted_values=pred.bag.gam.final,
                         time=test$time)
  FC2.Bag.RMSE.gam <- c(FC2.Bag.RMSE.gam,
                        sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                               length(data.gam$response)))
  print(c('FC2.Bag.gam',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                 length(data.gam$response))))
  pred.bag.tvcm.final <- rowMeans(pred.bag.tvcm)
  data.tvcm <- data.frame(response=test$FC,fitted_values=pred.bag.tvcm.final,
                          time=test$time)
  FC2.Bag.RMSE.tvcm <- c(FC2.Bag.RMSE.tvcm,
                         sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                length(data.tvcm$response)))
  print(c('FC2.Bag.tvcm',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                 length(data.tvcm$response))))
  print('FC2.bag',i)
}
...
for (i in 1:50) {
  ...
  Chla2.Bag.RMSE.glm <- c(Chla2.Bag.RMSE.glm,
                          sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                 length(data.glm$response)))
  print(c('Chla2.Bag.glm',i,sqrt(sum((data.glm$response-data.glm$fitted_values)^2)/
                                   length(data.glm$response))))
  pred.bag.gam.final <- rowMeans(pred.bag.gam)
  data.gam <- data.frame(response=test$Chla,fitted_values=pred.bag.gam.final,
                         time=test$time)
  Chla2.Bag.RMSE.gam <- c(Chla2.Bag.RMSE.gam,
                          sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                 length(data.gam$response)))
  print(c('Chla2.Bag.gam',i,sqrt(sum((data.gam$response-data.gam$fitted_values)^2)/
                                   length(data.gam$response))))
  pred.bag.tvcm.final <- rowMeans(pred.bag.tvcm)
  data.tvcm <- data.frame(response=test$Chla,fitted_values=pred.bag.tvcm.final,
                          time=test$time)
  Chla2.Bag.RMSE.tvcm <- c(Chla2.Bag.RMSE.tvcm,
                           sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                  length(data.tvcm$response)))
  print(c('Chla2.Bag.tvcm',i,sqrt(sum((data.tvcm$response-data.tvcm$fitted_values)^2)/
                                   length(data.tvcm$response))))
  print('Chla2.bag',i)
}
