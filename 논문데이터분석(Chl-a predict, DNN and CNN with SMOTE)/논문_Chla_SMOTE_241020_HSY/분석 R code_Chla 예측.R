...
SC <- read.csv("C:/Users/User/Desktop/seungchon_2016-2023.csv", sep=",", header=T, fileEncoding="CP949")
JS <- read.csv("C:/Users/User/Desktop/juksan_2016-2023.csv", sep=",", header=T, fileEncoding="CP949")

## Divide train and test

SC_train <- SC[SC$Year != 2023,]
SC_test <- SC[SC$Year == 2023,]

JS_train <- JS[JS$Year != 2023,]
JS_test <- JS[JS$Year == 2023,]
