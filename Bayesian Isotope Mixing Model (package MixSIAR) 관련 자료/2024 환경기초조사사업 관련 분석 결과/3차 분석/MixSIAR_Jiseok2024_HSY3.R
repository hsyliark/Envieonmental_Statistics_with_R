...
# Load mix data
mix <- load_mix_data(filename="C:/Users/User/Desktop/R MixSIAR 분석결과 정리_영산강/2024 환경기초조사사업 관련/BIMM 적합결과/3차 분석/Jiseok2024_consumer_ver2.csv",
                     iso_names=c("BIX","FI"),
                     factors="rain",
                     fac_random=TRUE,
                     fac_nested=FALSE,
...
# Load source data
source <- load_source_data(filename="C:/Users/User/Desktop/R MixSIAR 분석결과 정리_영산강/2024 환경기초조사사업 관련/BIMM 적합결과/3차 분석/Jiseok2024_sources_raw_ver2.csv",
                           source_factors=NULL,
                           conc_dep=FALSE,
                           data_type="raw",
                           mix)
...
discr <- load_discr_data(filename="C:/Users/User/Desktop/R MixSIAR 분석결과 정리_영산강/2024 환경기초조사사업 관련/BIMM 적합결과/3차 분석/Jiseok2024_discrimination_no_ver2.csv", 
                         mix)
