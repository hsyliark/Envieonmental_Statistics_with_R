...
group1 <- read.csv("D:/Workplace/Environmental_Statistics_with_R/논문데이터분석(군집분석자료)/수정자료/결과3/data3_g1.csv", sep=",", header=T)
group2 <- read.csv("D:/Workplace/Environmental_Statistics_with_R/논문데이터분석(군집분석자료)/수정자료/결과3/data3_g2.csv", sep=",", header=T)
group3 <- read.csv("D:/Workplace/Environmental_Statistics_with_R/논문데이터분석(군집분석자료)/수정자료/결과3/data3_g3.csv", sep=",", header=T)
