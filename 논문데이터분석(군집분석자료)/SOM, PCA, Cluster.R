...
data1 <- read.csv("C:/Users/Nier/Desktop/FW_ RE_ 군집분석자료/결과1/SOM 분석용_17_LKL.csv", sep=",", header=T)
data1_name <- data1[,1]
data1 <- data1[,-1]
rownames(data1) <- data1_name
data2 <- read.csv("C:/Users/Nier/Desktop/FW_ RE_ 군집분석자료/결과2/SOM 분석용_Total_AF_16.csv", sep=",", header=T)
data2 <- data2[-(146:147),]
data2_name <- data2[,1]
data2 <- data2[,-1]
rownames(data2) <- data2_name
data3 <- read.csv("C:/Users/Nier/Desktop/FW_ RE_ 군집분석자료/결과3/SOM 분석용_Total_BF_11.csv", sep=",", header=T)
data3_name <- data3[,1]
data3 <- data3[,-1]
