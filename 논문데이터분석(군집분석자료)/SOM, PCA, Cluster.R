## PCA
data_all <- read.csv("C:/Users/Nier/Desktop/?���???úм?_hsy/?���?????ͺм?(Evaluation and Grade Classification of River Water Quality Using Statistical Techniques)/?ּ??км?.csv", sep=",", header=T)
...
water <- read.csv("C:/Users/Nier/Desktop/?���???úм?_hsy/?���?????ͺм?(Evaluation and Grade Classification of River Water Quality Using Statistical Techniques)/cluster.csv", sep=",", header=T)
water_name <- water[,1]
water <- water[,-1]
