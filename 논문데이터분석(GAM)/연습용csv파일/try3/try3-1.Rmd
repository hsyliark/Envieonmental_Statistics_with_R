...
#### 최종선택된 모형의 설명력 : 62.4%(다중선형회귀모형), 71.5%(일반화가법모형) 

#### 일반화가법모형이 다중선형회귀모형보다 설명력이 우수하다는 것을 확실하게 보여주기 위해서는 설명변수들과 확실한 비선형관계가 있다고 여겨지는 변수를 반응변수로 선택하는 것이 좋다고 판단됨.
...
#### 최종선택된 모형의 설명력 : 60.4%(다중선형회귀모형), 67.7%(일반화가법모형) 
...
#### 최종선택된 모형의 설명력 : 48.1%(다중선형회귀모형), 55.8%(일반화가법모형) 
...
#### 최종선택된 모형의 설명력 : 39.9%(다중선형회귀모형), 76.2%(일반화가법모형) 
