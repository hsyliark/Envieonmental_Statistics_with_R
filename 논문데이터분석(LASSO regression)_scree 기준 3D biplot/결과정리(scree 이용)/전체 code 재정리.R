water <- read.csv("D:/Workplace/Environmental_Statistics_with_R/논문데이터분석(LASSO regression)_scree 기준 3D biplot/결과정리(scree 이용)/PCA에 Rain 포함/csv파일/0_전체지점.csv", sep=",", header=T)
water1 <- water
