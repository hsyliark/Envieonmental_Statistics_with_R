water <- read.csv("C:/Users/Administrator/Desktop/논문데이터분석(LASSO regression)_scree 기준,3D biplot/결과정리(scree 이용)/PCA에 Rain, Flow 포함/csv파일/10_함평.csv", sep=",", header=T)
water1 <- water
