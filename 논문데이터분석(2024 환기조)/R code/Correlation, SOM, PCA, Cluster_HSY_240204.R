...
## Loading data
water_day <- read.csv("C:/Users/Hi/Desktop/2024 환경기초조사사업/데이터 수집/231214/일자료/2012-2023 일자료.csv",             
...
# by year average
water <- read.csv("C:/Users/Hi/Desktop/2024 환경기초조사사업/데이터 수집/240204/average 2019-2023.csv",
                  sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
water_name <- water[,1]
water <- water[,-1]
...
k1 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/K-means/k1_2023.csv",  
                  sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
k1_name <- k1[,1]
k1 <- k1[,-1]
rownames(k1) <- k1_name

k2 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/K-means/k2_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
k2_name <- k2[,1]
k2 <- k2[,-1]
rownames(k2) <- k2_name

k3 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/K-means/k3_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
k3_name <- k3[,1]
k3 <- k3[,-1]
rownames(k3) <- k3_name

g1 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/GMM/g1_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
g1_name <- g1[,1]
g1 <- g1[,-1]
rownames(g1) <- g1_name

g2 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/GMM/g2_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
g2_name <- g2[,1]
g2 <- g2[,-1]
rownames(g2) <- g2_name

g3 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/GMM/g3_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
g3_name <- g3[,1]
g3 <- g3[,-1]
rownames(g3) <- g3_name

s1 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/SOM/s1_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
s1_name <- s1[,1]
s1 <- s1[,-1]
rownames(s1) <- s1_name

s2 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/SOM/s2_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
s2_name <- s2[,1]
s2 <- s2[,-1]
rownames(s2) <- s2_name

s3 <- read.csv("C:/Users/Hi/Desktop/2024 ???경기초조?????????/????????? ??????/231227/CA/SOM/s3_2023.csv",  
               sep=",", header=T, fileEncoding = "CP949", encoding = "UTF-8")
s3_name <- s3[,1]
s3 <- s3[,-1]
rownames(s3) <- s3_name
