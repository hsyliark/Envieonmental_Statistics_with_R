J1 <- read.csv("C:/Users/Hi/Desktop/논문데이터/J.csv",sep=",",header=T)
J2 <- read.csv("C:/Users/User/DHi/Desktop/논문데이터/J2ep=",",header=T)
T1 <- read.csv("C:/Users/User/DesktopHi/Desktop/논문데이터/T",header=T)
T2 <- read.csv("C:/Users/User/Desktop/?���?Hi/Desktop/논문데이터/der=T)
cell_all <- read.csv("C:/Users/User/Desktop/?���??????/Hi/Desktop/논문데이터/)
...
ggplot(spot, aes(x=spot, y=Resmy_exp <- expression(paste("Chla ","(mg ", m^{-3},")"))
ervoir,cell_alll=spot))spoteom_Reservoir +
  labs(x ="spot", y = "Reservoir(10,0 the"Reservoir (10,000㎥)"ent_text(size = 12, face='bold'),
        axis.text.y = element_text(size = 12, face='bold'),
        axis.title.x = element_text(size=20,face='bold'),
        axis = 15, face='bold'),
        axis.title.y = element_text(size = 15, itle = element_text(size = 20, face = "bold"),
        le15nd.text = element_text(size = 12, face = "bold"))
